...
mu = 0.54/24.0   # unlimited growth rate of SAR-11 in the experiments in 1/h
...
#---------------------------------------------------------------
fig,ax = plt.subplots()
ax.semilogy(sol1.t, sol1.y[0], 'b-', label="Fe' with 25 nM EntB")
ax.semilogy(sol2.t, sol2.y[0], 'b--', label="Fe' with 50 nM EntB")
ax.semilogy(sol3.t, sol3.y[0], 'b-.', label="Fe' with 100 nM EntB")
ax.semilogy(teval, BFe, 'r-', label="cumulative Fe uptake")
ax.legend()
ax.set_xlabel("t [hr]")
ax.set_ylabel("Fe species [M]")
ax.grid()
plt.savefig("uptake_enterobactin.png")
#plt.show()
