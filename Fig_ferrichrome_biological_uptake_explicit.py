...
ax[0].semilogy(sol1.t, sol1.y[0], 'b-', label="Fe' with 25 nM ferrichrome")
ax[0].semilogy(sol2.t, sol2.y[0], 'b--', label="Fe' with 50 nM ferrichrome")
ax[0].semilogy(sol3.t, sol3.y[0], 'b-.', label="Fe' with 100 nM ferrichrome")
...
ax[1].semilogy(sol1.t, sol1.y[4], 'b-', label="with 25 nM ferrichrome")
ax[1].semilogy(sol2.t, sol2.y[4], 'b--', label="with 50 nM ferrichrome")
ax[1].semilogy(sol3.t, sol3.y[4], 'b-.', label="with 100 nM ferrichrome")
# ax.semilogy(teval, BFe, 'r-', label="cumulative Fe uptake")
ax[1].legend()
...
plt.savefig("uptake_explicit_ferrichrome_5pM.png")
plt.show()
